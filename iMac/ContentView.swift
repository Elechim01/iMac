...
//  iMac
//
//  Created by Michele Manniello on 03/08/21.
//
...
struct TypeC : View {
    ...
    var thinderbolt : Bool = false
    var body: some View{
        VStack(spacing: 5){
//            showing thundelbolt logo if true....
            Image("thunderbold")
                .resizable()
...
//                    gradient...
    ...
    func getGradient()->[Color]{
        ...
        let colors : [Color] = [
            .white.opacity(0.1),
            .white.opacity(0.2),
//            Increasing Stand color to get shadow...
        ] + stand
